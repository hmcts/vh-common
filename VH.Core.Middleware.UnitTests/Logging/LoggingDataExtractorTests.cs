...
using VH.Core.Middleware.UnitTests.TestEntities;

namespace VH.Core.Middleware.UnitTests.Logging
{
    [TestFixture]
    public class LoggingDataExtractorTests
    {
        ...
        {
            // Arrange
            var conference = new LoggingTestEntity(Guid.NewGuid(), "CaseType", DateTime.UtcNow, "CaseNumber", "CaseName", "HearingVenueName", false, "IngestUrl");
